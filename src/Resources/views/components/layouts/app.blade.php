...
<head>
  ...
  <!-- Favicons -->
  <link href="{{ asset('bible/images/icons/favicon.png') }}" rel="icon">
  <link href="{{ asset('bible/images/icons/apple-touch-icon.png') }}" rel="apple-touch-icon">
  <!-- Fonts -->
  ...
  <link rel="stylesheet" href="{{ asset('bible/css/custom.css') }}">
...
<body style="background-color: #f6f6f6;">
  ...
  <script src="{{ asset('bible/js/bootstrap-bundle.min.js') }}"></script>
  <script src="{{ asset('bible/js/custom.js') }}"></script>
  ...
  <script>
      ...
      channel.bind('Bishopm\\Bible\\Events\\NewLiveMessage', function() {
