...
use Illuminate\Http\Request, Log, DB, Bishopm\Bible\Libraries\Chord;
use App\Http\Requests, View, Bishopm\Bible\Http\Requests\GchordsRequest;
use App\Http\Controllers\Controller, Bishopm\Bible\Models\Gchord;
...
class GchordsController extends Controller
{
    ...
    public function index()
    {
        ...
        if (count($chords)){
            ...
            return view('bible::chords.index',$data);
        } else {
            return view('bible::chords.index');
        }
    }
    ...
    {
        $data['chordname']=$name;
        return view('bible::chords.create',$data);
    }
    ...
    public function show($id)
    {
        ...
        return view('bible::chords.edit',$data);
    }
