...
use Bishopm\Bible\Models\Series;
use Bishopm\Bible\Models\Individual;
use App\Http\Controllers\Controller;
use Bishopm\Bible\Http\Requests\CreateCommentRequest;
use Bishopm\Bible\Http\Requests\CreateSermonRequest;
use Bishopm\Bible\Http\Requests\UpdateSermonRequest;
use Bishopm\Bible\Notifications\NewSermonComment;
...
class SermonsController extends Controller
{
    ...
    public function edit($series, Sermon $sermon)
    {
        ...
        $data['sermon'] = $sermon;
        return view('bible::sermons.edit', $data);
    }
    ...
    public function create($series_id)
    {
        ...
        return view('bible::sermons.create', $data);
    }

    public function show(Sermon $sermon)
    {
        $data['sermon']=$sermon;
        return view('bible::sermons.show', $data);
    }
