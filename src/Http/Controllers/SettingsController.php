...
use Bishopm\Bible\Repositories\CircuitsRepository;
use Bishopm\Bible\Repositories\GroupsRepository;
use Bishopm\Bible\Repositories\RostersRepository;
...
use Bishopm\Bible\Models\Roster;
use Spatie\Activitylog\Models\Activity;
use App\Http\Controllers\Controller;
use Bishopm\Bible\Http\Requests\CreateSettingRequest;
use Bishopm\Bible\Http\Requests\UpdateSettingRequest;
...
class SettingsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('bible::settings.index', compact('settings'));
    }

    public function modulesindex()
    {
        $modules = $this->setting->allmodules();
        return view('bible::settings.modules', compact('modules'));
    }
    ...
    public function extedit($id)
    {
        ...
        return view('bible::settings.extedit', compact('setting'));
    }
    ...
    public function edit(Setting $setting)
    {
        ...
        return view('bible::settings.edit', compact('setting', 'dropdown'));
    }
    ...
    public function userlogs()
    {
        ...
        return view('bible::settings.userlogs', compact('activities'));
    }

    public function create()
    {
        return view('bible::settings.create');
    }
    ...
    public function analytics()
    {
        ...
        arsort($analytics);
        return view('bible::settings.analytics', compact('analytics'));
    }
}
