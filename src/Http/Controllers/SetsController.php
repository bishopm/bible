...
use Bishopm\Bible\Http\Requests\CreateSetRequest;
use Bishopm\Bible\Http\Requests\UpdateSetRequest;
use App\Http\Controllers\Controller;
use Bishopm\Bible\Models\Song;
use Bishopm\Bible\Models\Individual;
use Bishopm\Bible\Models\Setitem;
use Bishopm\Bible\Models\Set;
...
use Bishopm\Bible\Notifications\WorshipSetNotification;
...
class SetsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('bible::sets.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('bible::sets.create', $data);
    }
    ...
    public function show($id)
    {
        ...
        return view('bible::sets.show', $data);
    }
