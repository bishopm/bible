...
use Bishopm\Bible\Repositories\StatisticsRepository;
use Bishopm\Bible\Repositories\SettingsRepository;
use Bishopm\Bible\Models\Statistic;
use Bishopm\Bible\Models\Setting;
use App\Http\Controllers\Controller;
use Bishopm\Bible\Http\Requests\CreateStatisticRequest;
use Bishopm\Bible\Http\Requests\UpdateStatisticRequest;
use Bishopm\Bible\Charts\ChurchattendanceChart;
...
class StatisticsController extends Controller
{
    ...
    public function index()
    {
        ...
        if (count($stats)) {
            ...
            return view('bible::statistics.index', compact('statistics', 'servicetimes'));
        } else {
    ...
    public function edit($id)
    {
        ...
        return view('bible::statistics.edit', compact('statistic', 'services'));
    }

    public function create()
    {
        $services=$this->servicetimes;
        return view('bible::statistics.create', compact('services'));
    }

    public function show()
    {
        $data['statistic']=$statistic;
        return view('bible::statistics.show', $data);
    }
    ...
    public function showhistory($service, $years=3)
    {
        ...
        return view('bible::statistics.history', $data);
    }
    ...
    public function showgraph($year="")
    {
        ...
        $data['thisyr']=$year;
        return view('bible::statistics.graph', $data);
    }
