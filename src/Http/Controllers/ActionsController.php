...
use Auth;
use JWTAuth;
use Bishopm\Bible\Models\Action;
...
use Bishopm\Bible\Http\Requests\CreateActionRequest;
use Bishopm\Bible\Http\Requests\UpdateActionRequest;
...
class ActionsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('bible::actions.index', $data);
    }
    ...
    public function create($id)
    {
        ...
        return view('bible::actions.create', compact('folders', 'tags', 'project'));
    }
    ...
    public function generalcreate()
    {
        ...
        $folders=$this->folders->dropdown();
        $tags=Action::allTags()->get();
        return view('bible::actions.gencreate', compact('folders', 'tags', 'projects','individuals'));
    }
    ...
    public function edit(Action $action)
    {
        ...
        return view('bible::actions.edit', compact('action', 'project', 'folders', 'tags', 'atags'));
    }
