...
namespace Bishopm\Bible\Http\Controllers\Auth;
...
class LoginController extends Controller
{
    ...
    */
    ...
    public function showLoginForm()
    {
        ...
        return view('bible::auth.login', compact('churchname'));
    }
    ...
    public function handleProviderCallback($social)
    {
        ...
        if ($user) {
            ...
            return view('bible::auth.register', ['name' => $userSocial->getName(), 'email' => $userSocial->getEmail(), 'individuals'=>$individuals, 'services'=>$services, 'provider'=>$social, 'provider_id'=>$provider_id]);
        }
    }
}
