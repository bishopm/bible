...
class GroupsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('bible::groups.index', compact('groups'));
    }
    ...
    public function edit(Group $group)
    {
        ...
        return view('bible::groups.edit', compact('group', 'indivs'));
    }
    ...
    {
        $indivs=$this->individuals->all();
        return view('bible::groups.create', compact('indivs'));
    }
    ...
    public function show(Group $group)
    {
        ...
        return view('bible::groups.show', $data);
    }
