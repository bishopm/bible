...
use Bishopm\Bible\Http\Requests\CreatePreacherRequest;
use Bishopm\Bible\Http\Requests\UpdatePreacherRequest;
...
class PreachersController extends Controller
{
    ...
    public function index()
    {
        ...
        if (($preachers=="No valid url") or ($this->settings->getkey('circuit')=='')) {
            ...
            return view('bible::preachers.index', compact('preachers'));
        }
    }
    ...
    public function edit($id)
    {
        ...
        return view('bible::preachers.edit', $data);
    }
    ...
    public function create()
    {
        ...
        if (count($data['societies'])) {
            return view('bible::preachers.create', $data);
        } else {
    ...
    {
        $data['preacher']=$this->preacher->find($id);
        return view('bible::preachers.show', $data);
    }
