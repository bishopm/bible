...
use Bishopm\Bible\Http\Requests\CreateUserRequest;
use Bishopm\Bible\Http\Requests\UpdateUserRequest;
use Bishopm\Bible\Notifications\ProfileUpdated;
...
class UsersController extends Controller
{
    ...
    {
        $users = $this->user->all();
        return view('bible::users.index', compact('users'));
    }

    public function activate()
    {
        $users = $this->user->inactive();
        return view('bible::users.activate', compact('users'));
    }

    public function verify()
    {
        $users = $this->user->unverified();
        return view('bible::users.verify', compact('users'));
    }
    ...
    public function edit(User $user)
    {
        ...
        $data['user'] = $user;
        return view('bible::users.edit', $data);
    }
    ...
    public function show($user)
    {
        ...
        return view('bible::users.show', $data);
    }
    ...
    public function create()
    {
        ...
        return view('bible::users.create', $data);
    }
