...
use Bishopm\Bible\Http\Requests\CreateIndividualRequest;
use Bishopm\Bible\Http\Requests\UpdateIndividualRequest;
use DB;
...
class IndividualsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('bible::individuals.index', compact('individuals'));
    }
    ...
    public function edit($household, Individual $individual)
    {
        ...
        return view('bible::individuals.edit', compact('individual', 'media', 'households'));
    }
    ...
    {
        return view('bible::individuals.create', compact('household'));
    }
