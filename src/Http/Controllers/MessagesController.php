...
use Bishopm\Bible\Events\MessagePosted;
...
use Bishopm\Bible\Repositories\MessagesRepository;
use Bishopm\Bible\Http\Requests\MessageRequest;
...
class MessagesController extends Controller
{
    ...
    public function create($group=0)
    {
        ...
        return view('bible::messages.create', $data);
    }
    ...
    public function store(MessageRequest $request)
    {
        ...
        if ($request->msgtype=="email") {
            ...
            return view('bible::messages.emailresults', compact('results'));
        } elseif ($request->msgtype=="sms") {
            $results=$this->sendsms($request->smsmessage, $recipients);
            return view('bible::messages.smsresults', compact('results'));
