...
use Bishopm\Bible\Repositories\SeriesRepository;
use Bishopm\Bible\Repositories\SlideshowsRepository;
use Bishopm\Bible\Repositories\SermonsRepository;
use Bishopm\Bible\Repositories\BlogsRepository;
use Bishopm\Bible\Repositories\IndividualsRepository;
use Bishopm\Bible\Repositories\HouseholdsRepository;
use Bishopm\Bible\Repositories\ActionsRepository;
...
use Bishopm\Bible\Repositories\PaymentsRepository;
use Bishopm\Bible\Repositories\BlocksRepository;
use Bishopm\Bible\Models\Group;
use Bishopm\Bible\Models\Book;
use Bishopm\Bible\Models\Blog;
use Bishopm\Bible\Models\Post;
use Bishopm\Bible\Models\Sermon;
use Bishopm\Bible\Models\Specialday;
...
use App;
use MediaUploader;
use Bishopm\Bible\Notifications\SendMessage;
use Bishopm\Bible\Notifications\CheckUserRegistration;
use Bishopm\Bible\Http\Requests\NewUserRequest;
...
class WebController extends Controller
{
    ...
    public function dashboard(ActionsRepository $actions)
    {
        ...
        return view('bible::dashboard', $data);
    }
    ...
    public function webblog($yr, $mth='', $slug='', BlogsRepository $blogs)
    {
        ...
        if ($blog) {
            ...
            return view('bible::site.blog', compact('blog', 'comments', 'media', 'cloud'));
        } else {
            abort(404);
        }
    }
    ...
    public function webblogs()
    {
        ...
        return view('bible::site.blogs', compact('blogs', 'cloud'));
    }
    ...
    public function webperson($slug, IndividualsRepository $individual)
    {
        ...
        if ($person) {
            ...
            return view('bible::site.person', compact('person', 'staff'));
        } else {
            abort(404);
        }
    }
    ...
    public function websubject($tag)
    {
        ...
        return view('bible::site.subject', compact('blogs', 'sermons', 'tag', 'books', 'colwidth'));
    }
    ...
    public function webseries($series)
    {
        ...
        if ($series) {
            return view('bible::site.series', compact('series'));
        } else {
            abort(404);
        }
    }
    ...
    public function websermon($seriesslug, $sermonslug)
    {
        ...
        return view('bible::site.sermon', compact('series', 'sermon', 'comments', 'description'));
    }

    public function websermons()
    {
        $series = $this->series->allwithsermons();
        return view('bible::site.sermons', compact('series'));
    }
    ...
    public function webgroup($slug)
    {
        ...
        if ($group) {
            ...
            return view('bible::site.group', compact('group', 'signup', 'leader'));
        } else {
            abort(404);
        }
    }
    ...
    public function webgroupedit($slug)
    {
        ...
        if ($group) {
            if (Auth::user()->individual->id==$group->leader) {
                ...
                return view('bible::site.groupedit', compact('group', 'leader', 'indivs', 'individuals'));
            } else {
    ...
    public function weballgroups()
    {
        ...
        return view('bible::site.allgroups', compact('groups', 'blogs'));
    }
    ...
    public function comingup()
    {
        ...
        return view('bible::site.comingup', compact('events', 'blogs'));
    }
    ...
    public function webevent($slug)
    {
        ...
        return view('bible::site.event', compact('event', 'payment'));
    }
    ...
    public function webgroupcategory($category)
    {
        ...
        if ($groups) {
            return view('bible::site.groupcategory', compact('groups'));
        } else {
            abort(404);
        }
    }
    ...
    public function webuser($slug)
    {
        ...
        if ($individual) {
            ...
            if ($user) {
                ...
                return view('bible::site.user', compact('user', 'staff', 'comments', 'theme'));
            } else {
                abort(404);
            }
        } else {
    ...
    public function webuseredit($slug)
    {
        ...
        if ($individual) {
            ...
            return view('bible::site.editprofile', compact('individual', 'services'));
        } else {
            abort(404);
        }
    }
    ...
    public function webuserhouseholdedit()
    {
        ...
        return view('bible::site.edithousehold', compact('household', 'cellphones'));
    }
    ...
    public function webuserindividualedit($slug)
    {
        $individual = $this->individual->findBySlug($slug);
        $media="webpage";
        return view('bible::site.editindividual', compact('individual', 'media'));
    }
    ...
    public function webuserindividualadd()
    {
        $household=Auth::user()->individual->household;
        $media="webpage";
        return view('bible::site.addindividual', compact('household', 'media'));
    }

    public function webuseranniversaryedit($ann)
    {
        $special = Specialday::find($ann);
        return view('bible::site.editanniversary', compact('special'));
    }

    public function webuseranniversaryadd()
    {
        $household = Auth::user()->individual->household;
        return view('bible::site.addanniversary', compact('household'));
    }
    ...
    public function webcourses()
    {
        ...
        return view('bible::site.courses', $data);
    }

    public function webbooks()
    {
        $books = $this->books->all();
        return view('bible::site.books', compact('books'));
    }
    ...
    public function webauthor($author)
    {
        ...
        return view('bible::site.author', compact('author', 'books'));
    }
    ...
    public function mychurch()
    {
        ...
        return view('bible::site.mychurch', compact('users', 'services'));
    }
    ...
    public function mydetails()
    {
        ...
        if (($user) and (isset($user->individual))) {
            ...
            return view('bible::site.mydetails', compact('household', 'pg', 'householdpgs'));
        } else {
            return view('bible::site.mydetails');
        }
    }
    ...
    public function mygiving()
    {
        if (Auth::check()) {
            ...
            return view('bible::site.mygiving', compact('individual', 'payments'));
        } else {
            return view('bible::site.mygiving');
        }
    }
    ...
    public function uri($slug)
    {
        ...
        if ($data['page']) {
            ...
            return view('bible::templates.' . $template, $data);
        } else {
            abort(404);
        }
    }
    ...
    {
        $services=explode(',', $this->settingsarray['worship_services']);
        return view('bible::site.registeruser', compact('services'));
    }
    ...
    public function lectionary()
    {
        ...
        if (\Request::route()->getName()=="lectionary") {
            return view('bible::site.lectionary', $data);
        } else {
            $alldat=array();
