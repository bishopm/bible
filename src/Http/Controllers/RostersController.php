...
use Bishopm\Bible\Models\Society;
...
use Bishopm\Bible\Http\Requests\CreateRosterRequest;
use Bishopm\Bible\Http\Requests\UpdateRosterRequest;
use Illuminate\Http\Request;
use Bishopm\Bible\Libraries\SMSfunctions;
...
class RostersController extends Controller
{
    ...
    public function index()
    {
        ...
        return View::make('bible::rosters.index', $data);
    }
    ...
    public function create()
    {
        ...
        return View::make('bible::rosters.create', $data);
    }
    ...
    public function edit($id)
    {
        ...
        return View::make('bible::rosters.edit', $data);
    }
    ...
    public function sms($id, $send, Request $request)
    {
        ...
        if ($send=="preview") {
            return View::make('bible::rosters.sms', $data);
        } else {
            if ($settings['sms_provider']=="bulksms") {
        ...
        return View::make('bible::rosters.results', $data);
    }
    ...
    public function details($id, $year, $month)
    {
        ...
        if ($carryon) {
            ...
            return View::make('bible::rosters.details', $data);
        } else {
