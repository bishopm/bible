...
use Bishopm\Bible\Http\Requests\CreateGroupRequest;
use Bishopm\Bible\Http\Requests\UpdateGroupRequest;
use DB, Auth;
...
class EventsController extends Controller {
	...
	public function index()
	{
        $events = $this->group->eventsIncludingUnpublished();
   		return view('bible::events.index',compact('events'));
	}

	public function edit(Group $event)
    {
        $indivs=$this->individuals->all();
        return view('bible::events.edit', compact('event','indivs'));
    }

    public function create()
    {
        $indivs=$this->individuals->all();
        return view('bible::events.create',compact('indivs'));
    }
	...
	public function show(Group $event)
	{
        ...
        return view('bible::events.show',$data);
	}
    ...
    public function showsignup($slug)
    {
        ...
        return view('bible::site.eventsignup',compact('event','leader','people'));
    }
