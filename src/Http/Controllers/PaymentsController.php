...
use Bishopm\Bible\Http\Requests\CreatePaymentRequest;
use Bishopm\Bible\Http\Requests\UpdatePaymentRequest;
...
class PaymentsController extends Controller {
	...
	public function index()
	{
        $payments = DB::table('payments')->get();;
   		return view('bible::payments.index',compact('payments'));
	}
	...
	public function edit($payment)
    {
        ...
        return view('bible::payments.edit', compact('payment','pgs'));
    }

    public function create()
    {
        $pgs=$this->individual->givingnumbers();
        return view('bible::payments.create',compact('pgs'));
    }
    ...
    public function monthtotals($year){
        ...
        return view('bible::payments.monthlytotals',compact('year','data'));
    }
