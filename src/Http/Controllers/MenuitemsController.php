...
use Bishopm\Bible\Models\Menuitem;
use Illuminate\Http\Request;
use App\Http\Controllers\Controller;
use Bishopm\Bible\Http\Requests\CreateMenuitemRequest;
use Bishopm\Bible\Http\Requests\UpdateMenuitemRequest;
...
class MenuitemsController extends Controller {
	...
	public function index($menu)
	{
        ...
        $data['menu'];
   		return view('bible::menuitems.index',$data);
	}
	...
	public function edit($menu,Menuitem $menuitem)
    {
        ...
        $data['menu']=$menu;
        return view('bible::menuitems.edit', $data);
    }
    ...
    public function create($menu)
    {
        ...
        $data['menu']=$menu;
        return view('bible::menuitems.create',$data);
    }
