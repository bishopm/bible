...
use Auth;
use Bishopm\Bible\Libraries\Fpdf\Fpdf;
use Bishopm\Bible\Http\Requests\PlansRequest;
...
use Bishopm\Bible\Repositories\PreachersRepository;
use Bishopm\Bible\Repositories\PlansRepository;
...
class PlansController extends Controller
{
    ...
    public function show($yy, $qq, $aa)
    {
        ...
        if ($aa=="edit") {
            return view('bible::plans.edit', $data);
        } else {
            $data['pb']=$this->settings['presiding_bishop'];
            if (!$data['pb']) {
                return view('bible::shared.errors')->with('errormessage', 'Before you can view the plan, please enter the name of the Presiding Bishop');
            }
            $data['gs']=$this->settings['general_secretary'];
            if (!$data['gs']) {
                return view('bible::shared.errors')->with('errormessage', 'Before you can view the plan, please enter the name of the General Secretary');
            }
            $data['db']=$this->settings['district_bishop'];
            if (!$data['db']) {
                return view('bible::shared.errors')->with('errormessage', 'Before you can view the plan, please enter the name of the District Bishop');
            }
            $data['super']=$this->settings['superintendent'];
            if (!$data['super']) {
                return view('bible::shared.errors')->with('errormessage', 'Before you can view the plan, please specify who the Circuit Superintendent is');
            }
            $this->report($data);
        }
    }
