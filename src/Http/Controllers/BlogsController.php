...
use Bishopm\Bible\Http\Requests\CreateBlogRequest;
use Bishopm\Bible\Http\Requests\UpdateBlogRequest;
use Bishopm\Bible\Http\Requests\CreateCommentRequest;
use Bishopm\Bible\Notifications\NewBlogPost;
use Bishopm\Bible\Notifications\NewBlogComment;
use Carbon\Carbon;
use MediaUploader;
...
class BlogsController extends Controller {
	...
	{
        $blogs = $this->blog->all();
   		return view('bible::blogs.index',compact('blogs'));
	}
	...
	public function edit(Blog $blog)
    {
        ...
        return view('bible::blogs.edit', compact('blog','bloggers','tags','btags','media'));
    }
    ...
    public function create()
    {
        $tags=Blog::allTags()->get();
        $bloggers=$this->bloggers;
        return view('bible::blogs.create',compact('bloggers','tags'));
    }

	public function show(Blog $blog)
	{
        $data['blog']=$blog;
        return view('bible::blogs.show',$data);
	}
