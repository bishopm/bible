...
use Bishopm\Bible\Http\Requests\CreateBookRequest;
use Bishopm\Bible\Http\Requests\CreateOrderRequest;
use Bishopm\Bible\Http\Requests\UpdateBookRequest;
use Bishopm\Bible\Http\Requests\CreateCommentRequest;
use Bishopm\Bible\Mail\GenericMail;
...
class BooksController extends Controller
{
    ...
    {
        $books = $this->book->all();
        return view('bible::books.index', compact('books'));
    }
    ...
    public function edit(Book $book)
    {
        ...
        return view('bible::books.edit', compact('book', 'tags', 'btags', 'suppliers', 'transactions'));
    }
    ...
    public function create()
    {
        ...
        $suppliers=$this->suppliers->all();
        if (count($suppliers)) {
            return view('bible::books.create', compact('tags', 'suppliers'));
        } else {
    ...
    public function show($slug)
    {
        ...
        if ($data['book']) {
            ...
            return view('bible::site.book', $data);
        } else {
            abort(404);
        }
    }
