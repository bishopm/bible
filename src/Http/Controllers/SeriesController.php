...
use Bishopm\Bible\Http\Requests\CreateSeriesRequest;
use Bishopm\Bible\Http\Requests\UpdateSeriesRequest;
use Carbon\Carbon;
...
class SeriesController extends Controller {
	...
	public function index()
	{
        $series = $this->series->all();
   		return view('bible::series.index',compact('series'));
	}

	public function edit(Series $series)
    {
        return view('bible::series.edit', compact('series'));
    }

    public function create()
    {
        return view('bible::series.create');
    }

	public function show(Series $series)
	{
        $data['series']=$series;
        return view('bible::series.show',$data);
	}
