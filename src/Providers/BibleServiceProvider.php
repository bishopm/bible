...
class ConnexionServiceProvider extends ServiceProvider
{
    ...
    public function boot(Dispatcher $events, SettingsRepository $settings)
    {
        ...
        if (Schema::hasTable('settings')) {
            ...
            config(['user-verification.email.view'=>'bible::emails.newuser']);
            ...
            Form::component('bsText', 'bible::components.text', ['name', 'label' => '', 'placeholder' => '', 'value' => null, 'attributes' => []]);
            Form::component('bsPassword', 'bible::components.password', ['name', 'label' => '', 'placeholder' => '', 'value' => null, 'attributes' => []]);
            Form::component('bsTextarea', 'bible::components.textarea', ['name', 'label' => '', 'placeholder' => '', 'value' => null, 'attributes' => []]);
            Form::component('bsThumbnail', 'bible::components.thumbnail', ['source', 'width' => '100', 'label' => '']);
            Form::component('bsImgpreview', 'bible::components.imgpreview', ['source', 'width' => '200', 'label' => '']);
            Form::component('bsHidden', 'bible::components.hidden', ['name', 'value' => null]);
            Form::component('bsSelect', 'bible::components.select', ['name', 'label' => '', 'options' => [], 'value' => null, 'attributes' => []]);
            Form::component('pgHeader', 'bible::components.pgHeader', ['pgtitle', 'prevtitle', 'prevroute']);
            Form::component('pgButtons', 'bible::components.pgButtons', ['actionLabel', 'cancelRoute']);
            Form::component('bsFile', 'bible::components.file', ['name', 'attributes' => []]);
            ...
            view()->composer('bible::templates.*', \Bishopm\Bible\Composers\MenuComposer::class);
            view()->composer('bible::worship.page', \Bishopm\Bible\Composers\SongComposer::class);
            view()->composer('bible::site.*', \Bishopm\Bible\Composers\SlideComposer::class);
            view()->composer('bible::posts.*', \Bishopm\Bible\Composers\SlideComposer::class);
            view()->composer('bible::templates.webpage_no_sidebar', \Bishopm\Bible\Composers\SlideComposer::class);
            view()->composer('bible::templates.sidebar_right', \Bishopm\Bible\Composers\SlideComposer::class);
            view()->composer('bible::templates.map_page', \Bishopm\Bible\Composers\SlideComposer::class);
    ...
    public function register()
    {
        ...
        $this->app->register('Bishopm\Bible\Providers\EventServiceProvider');
        $this->app->register('Bishopm\Bible\Providers\ScheduleServiceProvider');
    ...
    private function registerBindings()
    {
        ...
        $this->app->bind(
            'Bishopm\Bible\Repositories\BlocksRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\BlocksRepository(new \Bishopm\Bible\Models\Block());
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\BlogsRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\BlogsRepository(new \Bishopm\Bible\Models\Blog());
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\BooksRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\BooksRepository(new \Bishopm\Bible\Models\Book());
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\CircuitsRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\CircuitsRepository('circuits');
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\CommentsRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\CommentsRepository(new \Actuallymab\LaravelComment\Models\Comment());
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\CoursesRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\CoursesRepository(new \Bishopm\Bible\Models\Course());
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\EmployeesRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\EmployeesRepository(new \Bishopm\Bible\Models\Employee());
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\FoldersRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\FoldersRepository(new \Bishopm\Bible\Models\Folder());
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\GroupsRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\GroupsRepository(new \Bishopm\Bible\Models\Group());
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\HouseholdsRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\HouseholdsRepository(new \Bishopm\Bible\Models\Household());
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\IndividualsRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\IndividualsRepository(new \Bishopm\Bible\Models\Individual());
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\MeetingsRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\MeetingsRepository('meetings');
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\MenusRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\MenusRepository(new \Bishopm\Bible\Models\Menu());
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\MenuitemsRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\MenuitemsRepository(new \Bishopm\Bible\Models\Menuitem());
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\MessagesRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\MessagesRepository(new \Bishopm\Bible\Models\Message());
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\PagesRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\PagesRepository(new \Bishopm\Bible\Models\Page());
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\PastoralsRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\PastoralsRepository(new \Bishopm\Bible\Models\Pastoral());
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\PaymentsRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\PaymentsRepository(new \Bishopm\Bible\Models\Payment());
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\PlansRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\PlansRepository('plans');
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\PostsRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\PostsRepository(new \Bishopm\Bible\Models\Post());
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\PreachersRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\PreachersRepository('preachers');
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\ProjectsRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\ProjectsRepository(new \Bishopm\Bible\Models\Project());
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\RostersRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\RostersRepository(new \Bishopm\Bible\Models\Roster());
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\SeriesRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\SeriesRepository(new \Bishopm\Bible\Models\Series());
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\SermonsRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\SermonsRepository(new \Bishopm\Bible\Models\Sermon());
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\ServicesRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\ServicesRepository('services');
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\ServicetypesRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\ServicetypesRepository('tags');
                return $repository;
            }
        );
        $this->app->bind(
        ...
        $this->app->bind(
            'Bishopm\Bible\Repositories\SlidesRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\SlidesRepository(new \Bishopm\Bible\Models\Slide());
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\SlideshowsRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\SlideshowsRepository(new \Bishopm\Bible\Models\Slideshow());
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\SocietiesRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\SocietiesRepository('societies');
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\SpecialdaysRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\SpecialdaysRepository(new \Bishopm\Bible\Models\Specialday());
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\StatisticsRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\StatisticsRepository(new \Bishopm\Bible\Models\Statistic());
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\SuppliersRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\SuppliersRepository(new \Bishopm\Bible\Models\Supplier());
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\TransactionsRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\TransactionsRepository(new \Bishopm\Bible\Models\Transaction());
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\UsersRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\UsersRepository(new \Bishopm\Bible\Models\User());
                return $repository;
            }
        );
        $this->app->bind(
            'Bishopm\Bible\Repositories\WeekdaysRepository',
            function () {
                $repository = new \Bishopm\Bible\Repositories\WeekdaysRepository('weekdays');
                return $repository;
            }
        );
    }
